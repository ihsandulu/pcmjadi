...
<body class="  " >
									...
									<tbody> 
										...
										<tr style="<?=$warna;?>">
										  ...
										  <td><?=$taskproduct->taskproduct_remarks;?></td>
											...
											<td><?php if($taskproduct->taskproduct_picture==""){$taskproduct_picture="noimage.png";}else{$taskproduct_picture=$taskproduct->taskproduct_picture;}?>
  ...
  <?php }?>                                            </td>
											<td>
											<?php
											if($taskproduct->taskproduct_qty==1){echo "Done";}else{echo"Proses";}
											?>
											</td>
											<?php if(!isset($_GET['report'])){?>
											<?php if($this->session->userdata("position_id")==2){?>
											...
											<?php
											if($taskproduct->taskproduct_qty==1){echo "Done";}else{
											?>
												<form method="post" class="col-md-6" style="padding:0px;">
