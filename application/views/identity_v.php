...
<head>
	...
	<style>
	.keterangan{ font-size:10px; color:#FF0000; margin-bottom:25px;}
	</style>
</head>
						...
						<div class="">
							...
							<form class="form-horizontal" method="post" enctype="multipart/form-data">
							  ...
							  <div class="form-group">
								...
								<div class="col-sm-10">
								  <input type="text" autofocus class="form-control" id="identity_company" name="identity_company" placeholder="Enter Company" value="<?=$identity_company;?>">
								</div>
							  </div>
							  <div class="form-group">
								<label class="control-label col-sm-2" for="identity_slogan">Motto:</label>
								<div class="col-sm-10">
								  <input type="text" autofocus class="form-control" id="identity_slogan" name="identity_slogan" placeholder="Enter Motto" value="<?=$identity_slogan;?>">
								</div>
							  </div>
							   <div class="form-group">
								<label class="control-label col-sm-2" for="identity_services">Services:</label>
								<div class="col-sm-10">
								  <textarea type="text" autofocus class="form-control" id="identity_services" name="identity_services"><?=$identity_services;?></textarea>
								  <script>
									CKEDITOR.replace('identity_services');
								</script>
								</div>
							  </div>
							  <div class="form-group">
								...
								<div class="col-sm-10">
								  <input type="text" autofocus class="form-control" id="identity_email" name="identity_email" placeholder="Enter Email" value="<?=$identity_email;?>">
								</div>
							  </div>
							  <div class="form-group">
							  ...
							  <div class="form-group">
								...
								<div class="col-sm-10">
								  <input type="text" autofocus class="form-control" id="identity_city" name="identity_city" placeholder="Enter City" value="<?=$identity_city;?>">
								</div>
							  </div>
							  <div class="form-group">
								<label class="control-label col-sm-2" for="identity_address">Address:</label>
								<div class="col-sm-10">
								  <input type="text" autofocus class="form-control" id="identity_address" name="identity_address" placeholder="Enter Address" value="<?=$identity_address;?>">
								</div>
							  </div>
							  <div class="form-group">
								<label class="control-label col-sm-2" for="identity_phone">Phone:</label>
								<div class="col-sm-10">
								  <input type="text" autofocus class="form-control" id="identity_phone" name="identity_phone" placeholder="Enter Phone" value="<?=$identity_phone;?>">
								</div>
							  </div>
							  <div class="form-group">
								<label class="control-label col-sm-2" for="identity_fax">Fax:</label>
								<div class="col-sm-10">
								  <input type="text" autofocus class="form-control" id="identity_fax" name="identity_fax" placeholder="Enter Fax" value="<?=$identity_fax;?>">
								</div>
							  </div>
							  <div class="form-group">
								<label class="control-label col-sm-2" for="identity_cp">Contact Person:</label>
								<div class="col-sm-10">
								  <input type="text" autofocus class="form-control" id="identity_cp" name="identity_cp" placeholder="Enter CP" value="<?=$identity_cp;?>">
								</div>
							  </div>
							  <div class="form-group">
								<label class="control-label col-sm-2" for="identity_web">Web:</label>
								<div class="col-sm-10">
								  <input type="text" autofocus class="form-control" id="identity_web" name="identity_web" placeholder="Enter Site" value="<?=$identity_web;?>">
								</div>
							  </div>
							  <div class="form-group">
							  ...
							  <div class="form-group">
                                        ...
                                        <?php if($identity_picture!=""){$user_image="assets/images/identity_picture/".$identity_picture;}else{$user_image="assets/images/identity_picture/image.gif";}?>
										...
										<tr>			
											...
											<form class="form-horizontal" method="post" enctype="multipart/form-data">												
												<div class="form-group">
													...
													<div class="col-sm-10">
													  <input type="text" autofocus class="form-control" id="identity_npwp" name="identity_npwp" placeholder="Enter NPWP" value="<?=$identity->identity_npwp;?>">
													</div>
												</div>
												<div class="form-group">
											<label class="control-label col-sm-2" for="identity_npwpi"></label>
											<div class="col-sm-10" align="left"> 
											  <input type="file"  id="identity_npwpi" name="identity_npwpi"><br/>
											<?php if($identity->identity_npwpi!=""){$user_image="assets/images/identity_npwpi/".$identity->identity_npwpi;}else{$user_image="assets/images/identity_picture/image.gif";}?>
											  <img id="identity_npwpi_image" width="100" height="100" src="<?=base_url($user_image);?>"/>
											  <script>
												function readURL(input) {
													if (input.files && input.files[0]) {
														var reader = new FileReader();
														...
														reader.onload = function (e) {
															$('#identity_npwpi_image').attr('src', e.target.result);
														}
												...
												$("#identity_npwpi").change(function () {
													readURL(this);
												});
											  </script>
											</div>
										  ...
										  <input type="hidden" name="identity_id" value="<?=$identity->identity_id;?>"/>	
										  		<button type="submit" id="submit" class="btn btn-primary col-md-offset-2 col-md-10" name="change" value="OK">Submit</button>
										  	</form>
									  		</td>
