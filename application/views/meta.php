...
<style>
	...
	body::before {
    content: '';
    background-image: url('<?= base_url("assets/images/global/iPsyl.png"); ?>');
    background-repeat:repeat; /* Jangan ulangi gambar */
    background-position: center; /* Posisikan gambar di tengah */
    position: absolute; /* Posisikan pseudo-element secara absolut */
    top: 0;
    left: 0;
    right: 0;
    bottom: 0;
    opacity: 0.09; /* Atur tingkat transparansi background */
    z-index: -1; /* Pastikan pseudo-element berada di bawah konten body */
}
	...
	.backwhite {
		border-bottom: #C8D5DF solid 1px;
	}
