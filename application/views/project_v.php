						...
						<div class="">
							...
							<form class="form-horizontal" method="POST" enctype="multipart/form-data">
							  ...
							  <div class="form-group">
							    ...
							    <div class="form-group">
								<label class="control-label col-sm-2" for="project_status">Status Remarks  :</label>
								<div class="col-sm-10">
								  <textarea class="form-control" name="project_status" id="project_status"/><?=$project_status;?></textarea>
								<script>
									CKEDITOR.replace('project_status');
								</script>
								</div>
							  </div>
