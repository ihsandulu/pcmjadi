...
<head>
	...
	if(isset($_GET['tagihan'])){$urltagihan="&tagihan=".$this->input->get("tagihan");}else{$urltagihan="";}
	?>
</head>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			...
			<form method="post" class="col-md-4">							
				...
				<?php if(isset($_GET['project_id'])){$project_id=$_GET['project_id'];}else{$project_id="";}?>
				<button type="button" onClick="window.opener.location='<?=site_url("invpayment?inv_no=".$inv_no."&customer_id=".$customer_id."&project_id=".$project_id.$urltagihan);?>'; window.close();" class="btn btn-warning btn-lg" style=" float:right; margin:2px;"> Back</button>
							...
							<div class="box">
								...
								<table id="dataTable" class="table table-condensed table-hover">
									...
									<tbody> 
										...
										if($invpaymentproduct->invpaymentproduct_source=="petty_id"){$source="Petty Cash";}else{$source="Big Cash";}
										?>
										<tr>
											<td><?=$no;?></td>
										  	<td><?=$source;?></td>											
