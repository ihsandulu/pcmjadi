...
<head>
	...
	.backutama{margin-top:10px; position:fixed; left:50%; top:50%; transform:translate(-50%,-50%); width:100% !important;}
	@media screen and (min-width: 991px){
		.formin{ padding-left:5%; padding-right:5%;}
	...
	@media screen and (min-width: 480px & max-width: 500px){
		.backutama{height:300px; overflow:auto;}
	}
	...
	<div class="container-fluid backutama">
		...
		<div class="row" style="margin-top:30px;">
			<div class="col-md-12 scmlogo" style="padding-top:0px;">
				<div class="col-md-4 col-sm-4 col-xs-4 text-center" style="" align="center">
				...
				<div class="col-md-offset-4 col-sm-offset-4 col-xs-offset-4 col-md-4 col-sm-4 col-xs-4 text-center" style=" ">	
					<div class="col-md-12 col-sm-12 col-xs-12 " style="color:white; text-shadow:#C1BDBA 2px 2px 3px;">powered by</div>
