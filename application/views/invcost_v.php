	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			...
			<form method="post" class="col-md-4">							
				...
				<button type="button" onClick="window.opener.location='<?=site_url("invpayment?inv_no=".$inv_no."&customer_id=".$customer_id."&project_id=".$project_id);?>'; window.close();" class="btn btn-warning btn-lg" style=" float:right; margin:2px;"> Back</button>
