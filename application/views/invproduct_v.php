	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			...
			<form method="post" class="col-md-4">							
				...
				<button type="button" onClick="window.close(); window.opener.location.href = window.opener.location.href;" class="btn btn-warning btn-lg" style=" float:right; margin:2px;"> Back</button>
				...
				<div class="panel panel-default">
					...
					<?php if(isset($_POST['new'])||isset($_POST['edit'])){?>
						<div class="">
							<?php 
							if(isset($_GET['bap'])){
								$namabutton='name="bap"';$judul="Berita Acara Pemusnahan";
							}else{
								if(isset($_POST['edit'])){$namabutton='name="change"';$judul="Update Product";}else{$namabutton='name="create"';$judul="New Product";}	
							}?>
								...
								<table id="dataTable" class="table table-condensed table-hover">
									...
									<tbody> 
										...
										<tr>		
											...
											<?php }?>
											<td><?=number_format($invproduct->invproduct_price,0,",",".");?></td>
